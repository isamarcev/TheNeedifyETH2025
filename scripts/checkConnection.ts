...
//   console.log("\n\n\n");
//   const appSessionId = await client.createAppSession(new ethers.Wallet("0xfb02178446d96a32519e71f2a102ce646899219098d622e0dbe0bd1e343936b0"), new ethers.Wallet("0xfb02178446d96a32519e71f2a102ce646899219098d622e0dbe0bd1e343936b0"));
...
(async () => {
  try {
    const serverPrivateKey = "0x39590c6f031edbe054a6a4be603680eb6b72cc29d47c56876461ffef2b35e536";
    const serverWallet = privateKeyToAccount(serverPrivateKey);

    const sessionKey = "0xdce59f3d1db0a761ed881d425ff4f816f8e58f59130b9f485d9e97a847cb894f";
    const sessionWallet = privateKeyToAccount(sessionKey);

    // Create participants using viem accounts instead of ethers wallets
    const participantAKey = "0xfb02178446d96a32519e71f2a102ce646899219098d622e0dbe0bd1e343936b0";
    const participantBKey = "0xfb02178446d96a32519e71f2a102ce646899219098d622e0dbe0bd1e343936b0";
    
    const participantA = privateKeyToAccount(participantAKey);
    const participantB = privateKeyToAccount(participantBKey);

    console.log("Creating Yellow client...");
    let client = new YellowClient(
      "wss://clearnet.yellow.com/ws",
      serverWallet,
      sessionWallet
    ...
    await client.authenticate(10);
    
    console.log("Authentication successful!");
    console.log("\n--- Creating App Session ---");
    
    const appSessionId = await client.createAppSession(participantA, participantB);
