          ...
          >
              ...
              <div className="flex-1 pr-4">
                <div className="flex flex-wrap items-center gap-2 mb-3">
                  ...
                  <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium 
                    ${task.executor === null ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300" : 
                      task.owner_approved && task.executor_approved ? "bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300" : 
            ...
            <div className="border-t border-gray-200 dark:border-gray-800 my-4 pt-4">
              <div className="flex justify-between items-center mb-4">
                <div className="font-medium text-gray-900 dark:text-white">Reward</div>
                <div className="flex items-center">
                  <span className="font-bold text-yellow-500 text-xl mr-1">${task.amount}</span>
                  <span className="text-sm text-gray-500 dark:text-gray-400">{task.asset}</span>
                </div>
              </div>
              
              <div className="mb-4">
                <div className="font-medium text-gray-900 dark:text-white mb-2">Description</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div>
                  <div className="font-medium text-gray-900 dark:text-white mb-1">Created By</div>
                  <div 
                  ...
                  >
                    ...
                    {copiedAddresses["owner"] ? (
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 lg:h-8 lg:w-8 text-amber-600 dark:text-amber-500" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div>
                  <div className="font-medium text-gray-900 dark:text-white mb-1">Created On</div>
                ...
                <div>
                  <div className="font-medium text-gray-900 dark:text-white mb-1">Deadline</div>
                  <div className="text-gray-600 dark:text-gray-400">
                ...
                {task.executor && (
                  <div>
                    <div className="font-medium text-gray-900 dark:text-white mb-1">Assigned To</div>
                    <div 
                      className="text-gray-600 dark:text-gray-400 flex items-center gap-2 cursor-pointer hover:text-amber-600 dark:hover:text-amber-500 transition-colors"
                      onClick={() => copyToClipboard(task.executor!, "executor")}
                      title="Click to copy address"
                    >
              ...
              {task.taken_at && (
                <div className="mb-4">
                  <div className="font-medium text-gray-900 dark:text-white mb-1">Work Started</div>
                  <div className="text-gray-600 dark:text-gray-400">
